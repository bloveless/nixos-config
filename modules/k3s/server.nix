...

{
  ...
  config = {
    services.k3s = {
      role = "server";
      extraFlags = "--disable traefik --disable servicelb --disable-network-policy --cluster-cidr 10.24.0.0/16 --node-taint node-role.kubernetes.io/control-plane=true:NoSchedule";
